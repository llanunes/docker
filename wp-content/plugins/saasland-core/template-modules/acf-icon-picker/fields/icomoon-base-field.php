...
class acf_field_icomoon_base extends acf_field {
	...
	public function parse_css() {
		...
		$out = [];
		$arr_icons = saasland_themify_icons();
		array_shift( $arr_icons );
		
		foreach ( saasland_themify_icons() as $cs ) {
	...
	public function display_css() {
		...
		$font_urls = array(
			'woff2' => SAASLAND_CORE_DIR_FONT . '/themify-icon/fonts/themify.woff?ousyjt',
			'ttf'  => SAASLAND_CORE_DIR_FONT . '/themify-icon/fonts/themify.ttf?ousyjt',
			'woff' => SAASLAND_CORE_DIR_FONT . '/themify-icon/fonts/themify.woff?ousyjt',
			'svg'  => SAASLAND_CORE_DIR_FONT . '/themify-icon/fonts/themify.svg?ousyjt#themify'
		);
		/**
	...
	function input_admin_enqueue_scripts() {
		...
		$css_file = SAASLAND_CORE_DIR_FONT . '/themify-icon/themify-icons.min.css';
		/**
