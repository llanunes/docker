    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
			...
			[
				...
				'placeholder' => __( 'Feature Title', 'saasland-core' ),
			]
		);
        $repeater->add_control(
			'desc',
            ...
            <section class="best_screen_features_area features_area_pad">
                <?php if ( 'yes' === $settings['is_bg_shape']) : ?>
                    <svg xmlns="http://www.w3.org/2000/svg">
                        <path fill='<?php echo esc_attr($settings['bg_shape_color']); ?>' id="down_bg_copy_2" data-name="down / bg copy 2" d="M444.936,252.606c-148.312,0-305.161-29.63-444.936-80.214V0H1920V12S808.194,234.074,444.936,252.606Z"/>
                    </svg>
                <?php endif; ?>
                                    ...
                                    foreach ($features as $feature) {
                                        ...
                                        <div class="card wow fadeInUp <?php if ($count == 0) { echo esc_attr( 'active' ); }?>">
                                            <div class="card-header" id="heading-<?php echo esc_attr($feature['_id']); ?>">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-link" data-bs-toggle="collapse" data-bs-target="#collapse-<?php echo esc_attr($feature['_id']); ?>" aria-expanded="true" aria-controls="collapse-<?php echo esc_attr($feature['_id']); ?>">
                                                        <?php
                                                        if ( $feature['icon_type'] == 'font_icon' ) {
                                                            echo "<i class='{$feature['font_icon']}'></i>";
                                                        } else {
