                        ...
                        if ( is_array( $event_tabs ) && count( $event_tabs ) > 0 ){
                            ...
                            foreach ( $getCats as $cat ){
                                ...
                                $tabs .= '<li class="nav-item wow fadeInUp" data-wow-delay="0.4s">
                                             <a class="nav-link'. esc_attr( $active ) .'" id="tab'.esc_attr( $catForFilter ).'" data-bs-toggle="tab" href="#'.esc_attr( $catForFilter ).'" role="tab" aria-controls="one" aria-selected="'. esc_attr( $aria_selected ) .'">
