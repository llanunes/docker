...
class Portfolio extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Filterable Portfolio', 'saasland-core' );
    }
    ...
    protected function register_controls() {
	    ...
	    $this->add_control(
		    'is_pagination', [
			    'label' => esc_html__( 'Show Pagination', 'saasland-core' ),
			    'type' => Controls_Manager::SWITCHER,
			    'label_on' => __( 'Yes', 'saasland-core' ),
			    'label_off' => __( 'No', 'saasland-core' ),
			    'return_value' => 'yes',
        ...
        if( $settings['select_style'] == '2' ){
            ...
            <section class="<?php echo $is_show_count; echo $layout ?>">
                ...
                if ($settings['is_pagination'] == 'yes' ) {
                    ?>
                    <div class="portfolio navigation pagination mt-5">
                        <div class="col-lg-12 text-center nav-links">
			                <?php
