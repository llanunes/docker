...
class Saasland_Grid_Query
{
    ...
    public static function droit_pro_categories($id = '')
    {
        ...
        //$categories     = array('' => __('All Items', 'saasland-core'));
    ...
    public function render_pagination()
    {
        ...
        ?>
		<nav class="droitp-blog-pagination-container" role="navigation" aria-label="<?php echo esc_attr(__('Pagination', 'saasland-core')); ?>">
    ...
    protected function render_comments()
    {
        ...
        <span class="droit-blog-entry-comments">
            <?php 
                ...
                <?php } ?>
                <span class="dl-grid-comments"><?php echo get_comments_number(get_the_ID()); ?></span>
            </span>
        <?php
    }
