    ...
    class DL_Custom_CSS
    {
        ...
        public function _droit_custom_css( Element_Base $el ) {
            $el->start_controls_section(
                ...
                [
                    'label' => __( 'Custom CSS', 'saasland-core' ) . dl_get_icon() ,
            ...
            $el->add_control(
                ...
                [
                    'raw' => __( 'Add your own custom CSS here', 'saasland-core' ),
            ...
            $el->add_control(
                ...
                [
                    ...
                    'label' => __( 'Custom CSS', 'saasland-core' ),
                    'language' => 'css',
                    'render_type' => 'ui',
                    'show_label' => false,
                    'separator' => 'none',
            ...
            $el->add_control(
                ...
                [
                    'raw' => __( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'saasland-core' ),
                    'type' => \Elementor\Controls_Manager::RAW_HTML,
