...
class Button_Hover_Advanced extends \Elementor\Group_Control_Base
{
    ...
    protected function init_fields()
    {
        ...
        $fields['button_direction'] = [
            'label' => esc_html__('Direction', 'saasland-core'),
            'type' => \Elementor\Controls_Manager::CHOOSE,
            'options' => [
                'left' => [
        ...
        $fields['button_transition_type'] = [
            'label' => esc_html__('Transition Type', 'saasland-core'),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'linear' => 'Linear',
                'ease' => 'Ease',
        ...
        $fields['allow_box_shadow'] = [
            'label' => esc_html__('Enable Shadow', 'saasland-core'),
    ...
    protected function get_default_options()
    {
        return [
            'popover' => [
                ...
                'starter_title' => esc_html__('After Setting', 'saasland-core'),
                'settings' => [
                    'render_type' => 'ui',
