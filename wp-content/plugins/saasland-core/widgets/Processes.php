...
class Processes extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Processes', 'saasland-core' );
    }
            ...
            <section class="agency_featured_area">
                <div class="container">
                    ...
                    <div class="features_info">
                        <?php
                        if (count($rows) == 2) { ?>
                            <img class="dot_img" src="<?php echo plugins_url( 'images/dot_2_items.png', __FILE__) ?>" alt="<?php esc_attr_e('Shape', 'saasland-core' ); ?>">
                            <?php
                        } elseif (count($rows) == 3) { ?>
                            <img class="dot_img" src="<?php echo plugins_url( 'images/dot_3_items.png', __FILE__) ?>" alt="<?php esc_attr_e('Shape', 'saasland-core' ); ?>">
                            <?php
                        } elseif (count($rows) == 4) { ?>
                            <img class="dot_img" src="<?php echo plugins_url( 'images/dot_4_items.png', __FILE__) ?>" alt="<?php esc_attr_e('Shape', 'saasland-core' ); ?>">
                            <?php
                        } elseif (count($rows) == 5) { ?>
                            <img class="dot_img" src="<?php echo plugins_url( 'images/dot_5_items.png', __FILE__) ?>" alt="<?php esc_attr_e('Shape', 'saasland-core' ); ?>">
                            <?php
                        }
                        ?>
                        <?php
