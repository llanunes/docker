    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'style', [
                ...
                'options' => [
                    'style_00' => esc_html__( 'Style Zero with [Team Details]', 'saasland-core' ),
        ...
        $this->add_control(
            'designation_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} ._designation' => 'color: {{VALUE}}',
                ],
            ]
        ...
        $this->add_control(
            'description_color', [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} ._description' => 'color: {{VALUE}}',
                ],
            ]
        ); // End Content
        ...
        <div class="row">
                    ...
                    <div class="hover_content">
                        <div class="n_hover_content">
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a href="<?php echo esc_url($member['fb']['url']) ?>"
                                        <?php saasland_is_external($member['fb']) ?>>
                                ...
                                <li>
                                    <a href="<?php echo esc_url($member['twitter']['url']) ?>"
                                        <?php saasland_is_external($member['twitter']) ?>>
                                ...
                                <li>
                                    <a href="<?php echo esc_url($member['instagram']['url']) ?>"
                                        <?php saasland_is_external($member['twitter']) ?>>
                                ...
                                <li>
                                    <a href="<?php echo $member['pinterest']['url'] ?>"
                                        <?php saasland_is_external($member['pinterest']) ?>>
                                ...
                                <li>
                                    <a href="<?php echo $member['linkedin']['url'] ?>"
                                        <?php saasland_is_external($member['linkedin']) ?>>
            ...
            <div class="col-lg-12 text-center">
                <a href="<?php echo esc_url($settings['btn_url']['url']) ?>"
                    <?php saasland_is_external($settings['btn_url']) ?> class="learn_btn wow fadeInLeft"
                    data-wow-delay="0.2s">
    ...
    <?php
                        ...
                        if ( $team_member->have_posts() ) {
                            while ( $team_member->have_posts() ){
                                ...
                                $short_desc = function_exists( 'get_field' ) ? get_field( 'short_desc' ) : '';
                                $designation = function_exists( 'get_field' ) ? get_field( 'member_designation' ) : '';                         
                        ?>
    <div class="team_item">
        <a href="<?php the_permalink(); ?>" class="team_img">
            <?php the_post_thumbnail( 'full', array('')) ?>
        </a>
        <div class="content">
            <a href="<?php the_permalink(); ?>">
                <h4 title="name" class="_name"><?php the_title(); ?></h4>
            </a>
            <h3 class="_designation"><?php echo $designation; ?></h3>
            <div class="position _description"> <?php echo wp_trim_words( $short_desc, 15 ); ?> </div>
            <ul class="list-unstyled">
                <?php if( have_rows('member_social_profile') ): ?>
                <ul class="list-unstyled">
                    <?php while( have_rows('member_social_profile') ): the_row(); 
                        ?>
                    <li><a href="<?php the_sub_field('social_url'); ?>">
                            <i class="ti-<?php the_sub_field('socials_icons'); ?>"></i>
                        </a>
                    </li>
                    <?php endwhile; ?>
                </ul>
                ...
                <div class="ex_team_item wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="hover_content">
                        <div class="n_hover_content">
                            ...
                            <div class="br"></div>
                            <a href="<?php the_permalink(); ?>">
                                <h3 class="f_p f_size_16 f_600 w_color"> <?php the_title(); ?> </h3>
                            </a>
                            <h5> <?php echo esc_html( $designation ) ?> </h5>
