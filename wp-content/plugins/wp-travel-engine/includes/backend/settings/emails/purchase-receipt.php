...
<div class="wpte-field wpte-checkbox advance-checkbox">
	<label class="wpte-field-label" for="enable-customer-notification"><?php echo __( 'Enable Customer Notification', 'wp-travel-engine' ); ?></label>
	...
	<span class="wpte-tooltip"><?php echo __( 'Turn this off if you do not want to send email notification to customer.', 'wp-travel-engine' ); ?></span>
</div>

<div class="<?php wptravelengine_hidden_class( 'no' === $enable_customer_notification, true ); ?>" data-customer-email-section >
	...
	<div class="wpte-field wpte-text wpte-floated">
		...
		<span class="wpte-tooltip"><?php esc_html_e( 'Enter the subject line for the booking notification email. Available Tags: {booking_id}, {payment_id}, {sitename}, {name}, {fullname}', 'wp-travel-engine' ); ?></span>
	</div>
	...
	<div class="wpte-field wpte-text wpte-floated">
		<label class="wpte-field-label" for="wp_travel_engine_settings[email][subject]"><?php esc_html_e( 'Purchase Email Subject', 'wp-travel-engine' ); ?></label>
			...
			value="<?php echo esc_attr( $subject ); ?>" />
		<span class="wpte-tooltip"><?php esc_html_e( 'Enter the subject line for the purchase receipt email. Available Tags: {booking_id}, {payment_id}, {sitename}, {name}, {fullname}', 'wp-travel-engine' ); ?></span>
	</div>
	<div class="wpte-field wpte-textarea wpte-floated">
